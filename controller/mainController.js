        ...
        if (req.session.user) {
          ...
          if (menuRows.length > 0) {
            ...
            if (cartItemRows.length > 0) {
              ...
              // 새로운 메뉴인 경우 레코드 추가
              const insertMenuCartQuery = 'INSERT INTO bookcartlist (bookcartlist_bookname, bookcartlist_count, bookcart_bookcartid, book_book_no) VALUES (?, ?, ?, ?)';
              await pool.query(insertMenuCartQuery, [bookName, quantity, cartId, bookId]);
            }
